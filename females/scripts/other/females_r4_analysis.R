...
# Load data in
rep_4_dat <- read.csv("females/data/raw/soc_exp_fem_r4.csv") %>% 
  filter(behaviour != "trial start")

patch_table_focals <- read.csv("females/data/patch_tables/patch_focal_f4.csv")
patch_table_partner <- read.csv("females/data/patch_tables/patch_partner_f4.csv")

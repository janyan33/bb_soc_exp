...
# Load data in
rep_1_dat <- read.csv("males_summer_2023/data/soc_exp_male_r1.csv") %>% 
  filter(behaviour != "trial start")

patch_table_focals <- read.csv("males_summer_2023/data/patch_tables/patch_focal_f1.csv")
patch_table_partner <- read.csv("males_summer_2023/data/patch_tables/patch_partner_f1.csv")
...
# Looking for typos
unique(rep_1_dat$patch_partner)

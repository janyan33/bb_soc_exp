...
# Load data in
rep_3_dat <- read.csv("males_summer_2023/data/soc_exp_male_r3.csv") %>% 
  filter(behaviour != "trial start")

patch_table_focals <- read.csv("males_summer_2023/data/patch_tables/patch_focal_r3.csv")
patch_table_partner <- read.csv("males_summer_2023/data/patch_tables/patch_partner_r3.csv")
...
# Looking for typos
unique(rep_3_dat$patch_partner)
...
#write.csv(rep_3_dat, "rep_3_Rdata.csv")
